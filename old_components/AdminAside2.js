...
class AdminAside2 extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      isMenuVisible: false,
    ...
    return (
      <aside className="control-sidebar control-sidebar-dark">
        <ul className="nav nav-tabs nav-justified control-sidebar-tabs">
          <li>
            <Link href="#control-sidebar-home-tab" data-toggle="tab">
          ...
          <li>
            <Link href="#control-sidebar-settings-tab" data-toggle="tab">
